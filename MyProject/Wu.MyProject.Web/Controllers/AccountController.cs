...
namespace Wu.MyProject.Web.Controllers
{
    public class AccountController : MyProjectControllerBase
    {
        ...
        public ActionResult Test1()
        {
            ...
            _taskAppService.GetTasks(new GetTasksInput());
        ...
        private async System.Threading.Tasks.Task SignInAsync(User user, ClaimsIdentity identity = null, bool rememberMe = false)
        {
            if (identity == null)
            {
