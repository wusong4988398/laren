...
namespace Wu.MyProject.Tests
{
    public abstract class MyProjectTestBase : AbpIntegratedTestBase
    {
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<MyProjectApplicationModule>();
            modules.Add<MyProjectDataModule>();
        }

        public void UsingDbContext(Action<MyProjectDbContext> action)
        {
        ...
        public T UsingDbContext<T>(Func<MyProjectDbContext, T> func)
        {
            T result;
